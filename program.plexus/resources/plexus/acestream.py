...
def acestreams(name,iconimage,chid):
	...
	if settings.getSetting('engine_app') != '0' and settings.getSetting('engine_app') != '1' and settings.getSetting('engine_app') != '2':
		...
		if settings.getSetting('engine_app') == '0' and settings.getSetting('engine_app') == '1':
